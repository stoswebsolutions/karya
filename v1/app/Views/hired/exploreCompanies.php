                        ...
                        <div class="row gx-4">
                            <div class="col-9">
                                <div class="company-video">
                                    <h1 class="company"><?= $companyDetails['company_name'] ?></h1>
                                    <h6 class="abt-hdr">about</h6>
                                    <p class="info"><?= $companyDetails['company_history'] ?></p>
                                    <?php
                                    if (!empty($companyDetails['video_path'])) {
                                        $videoPath = site_url() . 'assets/uploads/company/' . $companyDetails['tb_company_id'] . '/' . str_replace('./uploads/company/', '', $companyDetails['video_path']) . '.mp4';
                                    } else {
                                        $videoPath = site_url() . 'assets/uploads/video_cv/Video Resume Sample.mp4';
                                    }
                                    ?>
                            ...
                            <div class="col-3">
                                ...
                                if (!empty($companyPhotos)) {
                                    if ($companyPhotos['company_photo_for'] == 'company_photo_formal') {
                                        $imagePath = site_url() . 'assets/uploads/company/' . $companyPhotos['tb_company_id'] . '/' . $companyPhotos['company_photo_file_name'];
                                    } else {
                                        $imagePath = site_url() . 'assets/uploads/company/comp1.jpg';
                                    }
                                } else {
                                    $imagePath = site_url() . 'assets/uploads/company/comp1.jpg';
                                }
                                ?>
                                <img src="<?= $imagePath ?>" alt="company image" class="w-100 h-100">
                            </div>
                        </div>
                        <div class="row gx-2 mt-2">
                            <?php
                            foreach ($compGallery as $index1 => $row1) {
                                $galleryPath = site_url() . 'assets/uploads/company/' . $row1['company_id'] . '/' . $row1['path'];
                            ?>
                                <div class="col-4">
                                    <img src="<?= $galleryPath ?>" alt="company image" class="w-100">
                                </div>
                            <?php
                            }
                            ?>
